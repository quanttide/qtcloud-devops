...
```
docs/                 ← 给人读、人维护（用户手册、教程、CLI 参考）
src/<模块>/docs/      ← 给 AI 读、AI 维护（开发设计文档、实现思路）
```

- 人维护的文档追求可读性和稳定性，不频繁修改
- AI 维护的文档追求准确性和完整性，随代码更新
- AI 在 `src/<模块>/docs/` 下的修改直接提交，不需要人确认
- 人在 `docs/` 下的修改高于 AI 的判断
