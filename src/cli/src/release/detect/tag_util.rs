...
pub(super) fn collect_tags_with_scope(root: &Path) -> HashMap<String, Vec<String>> {
...
pub(super) fn parse_tag(tag: &str) -> (Option<String>, &str) {
...
pub(super) fn parse_version(s: &str) -> Result<(u32, u32, u32, Option<String>, Option<u32>), DetectError> {
...
pub(super) fn build_version(parts: &VersionParts, increment: &str, prerelease: Option<&str>) -> String {
...
pub(super) fn apply_scope_prefix(scope: Option<&str>, version: &str) -> String {
    match scope {
