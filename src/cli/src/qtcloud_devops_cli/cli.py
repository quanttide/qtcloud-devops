...
def status(
    ...
    from qtcloud_devops_cli.code import status as _status
...
def sync(
    ...
    """同步子模块指针到父仓库"""
    from qtcloud_devops_cli.code import sync as _sync
...
def retire(
    ...
    from qtcloud_devops_cli.code import retire as _retire
...
def release(
    ...
    from qtcloud_devops_cli.release import run
