...
- [ ] 提取 `source/tag.rs` 纯函数到 toolkit（`parse_version` / `build_version` / 等待 [issue #6](https://github.com/quanttide/quanttide-devops-toolkit/issues/6)）

### SHOULD（函数 50-80 行 / 嵌套 5 层 / 文件 500-1000 行）
